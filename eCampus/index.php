...
$sql ="SELECT EmailId,Password,Status,id FROM employee WHERE EmailId=:uname and Password=:password";
...
//Then Redirect to the home page from here.
}
                                       ...
                                       <div class="row">
                                           <form class="col s12" name="signin" method="post" >
                                               ...
                                               <div class="col s12 right-align m-t-sm">
                                                   ...
                                                   <input type="submit" name="signin" value="Sign in" class="waves-effect waves-light btn teal"><a href="home.php"></a>
